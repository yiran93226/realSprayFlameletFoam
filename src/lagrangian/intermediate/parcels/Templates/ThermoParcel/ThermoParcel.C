...
) const
{
    ...
    //===== assume Ts=T for the initial value ========
    //Ts = T;
}
...
{
    //test 
    // Info<< "Yes, we in the calcHeatTransfer function." << endl;
    ...
    //test
    // Info<< "particle temperature change deltaT = " << deltaT << endl;
    // if (deltaTcp < 0)
    // {
    //     Info<< "deltaTcp = " << deltaTcp << " < 0, indicating temeprature updating is wrong..." << endl;
    // }
